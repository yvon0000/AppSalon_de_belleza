...
const resutado= await fetch('./servicios.json');
...
noServicio.textContent= "silvouple rampli tout enfomasyon yo";
...
function nombreCita(){
    ...
    nombreTexto.addEventListener('input', e=>{
        ...
        if(nombre ==='' ||nombre.length<3){
            mostraAlerta("nom sa pa korek",'error')
...
mostraAlerta("nou pa gen le pou jou samdi ak dimanch",'error');
    }else{
...
mostraAlerta("chwazi yon le antre 10h00 ak 20h00",'error')
